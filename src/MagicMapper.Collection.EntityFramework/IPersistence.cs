...
namespace MagicMapper.EntityFramework
{
    public interface IPersistence
    {
        ...
        /// </summary>
        /// <remarks>Uses <see cref="MagicMapper.EquivalencyExpression.EquivalentExpressions.GenerateEquality"/>> to find equality between Source and From Types to determine if insert or update</remarks>
